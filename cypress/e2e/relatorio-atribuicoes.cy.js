...
describe("US05 - Relatório de Atribuições por Área/Subárea", () => {
  beforeEach(() => {
    LoginPage.accessPageAfterLogin(
      "/portal_service/reports/assignments_by_area",
    );
  });
  ...
  it("Cenário 01: Validar exibição do Relatório Sintético e seus gráficos gerados", () => {
    ...
    RelatorioAtribuicoesPage.cardHeaderTitulo
      .should("be.visible")
      .and("contain.text", `Relatório Sintético - ${areaAlvo}`);
  ...
  it("Cenário 02: Validar estrutura do Relatório Analítico e tabela detalhada", () => {
    ...
    RelatorioAtribuicoesPage.cardHeaderTitulo
      .should("be.visible")
      .and("contain.text", `Relatório Analítico - ${areaAlvo}`);
